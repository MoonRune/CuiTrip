 ...
 */
public class TravelWaitCommentPresent  extends BaseOrderFormPresent<IFinderOrderDetailView> {

    public TravelWaitCommentPresent(IFinderOrderDetailView orderDetailView, OrderItem orderItem) {
