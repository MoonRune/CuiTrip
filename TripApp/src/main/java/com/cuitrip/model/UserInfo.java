...
public class UserInfo implements Serializable {
    ...
    public static final String ID_CHECK_NONE="0";//ing
    public static final String ID_CHECK_ING="1";//ing
    public static final String ID_CHECK_SUC="2";//ing
    public static final String ID_CHECK_FAILED="3";//ing
